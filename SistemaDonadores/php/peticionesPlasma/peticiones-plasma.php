...
<!--/////////////////////////////////elementos locales/////////////////////////////////////-->
  ...
  <link rel="stylesheet" type="text/css" href="../../css/main-content.css">
    <link rel="stylesheet" type="text/css" href="../../css/queriesPlasma.css">
...
<div class="sidenav">
  <div class="sideContent">
    ...
    <div class="hoverA"><a href="peticiones-plasma.php">Peticiones de Plasma</a></div>
...
<div class="sidenav_resp" id="sidenav_resp">
  <div class="sideContent_resp">
   ...
   <button class="dropbtn"  onclick="location.href='peticiones-plasma.php'" id="VistaCalidadObjetivos">Peticiones de Plasma</button>
...
<h2 class="h2Titulo">PETICIONES DE PLASMA</h2><br>
