...
<!--/////////////////////////////////elementos locales/////////////////////////////////////-->
  ...
  <link rel="stylesheet" type="text/css" href="../../css/main-content.css">
    <link rel="stylesheet" type="text/css" href="../../css/queriesSangre.css">
...
<div class="sidenav">
  <div class="sideContent">
    ...
    <div class="hoverA"><a href="peticiones-sangre.php">Peticiones de Sangre</a></div>
...
<div class="sidenav_resp" id="sidenav_resp">
  <div class="sideContent_resp">
    ...
    <button class="dropbtn"  onclick="location.href='peticiones-sangre.php'" id="VistaCalidadObjetivos">Peticiones de Sangre</button>
...
<h2 class="h2Titulo">PETICIONES DE SANGRE</h2><br>
<!--///////su css se encuentra en main-content///////////-->
