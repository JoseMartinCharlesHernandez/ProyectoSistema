...
<p>
	Se cuenta con 14 puestos de sangrado localizados en los hospitales en donde se realiza la extracción de unidades de sangre total, las cuales son enviadas para su procesamiento así como para la realización del tamizaje serológico y estudios de inmunohematología. Una vez procesadas las unidades de sangre son distribuidas a los hospitales de acuerdo a sus necesidades
</p>
<p>
	A continuación se enumeran dichos hospitales:
</p>

<ul class="cont-View-Operacion">
	<li>
		Hospital General de Tampico.
	</li>
	<li>
		Hospital General Altamira.
	</li>
	<li>
	...
	<li>
		Hospital General Valle Hermoso.
	</li>
	<li>
	...
	<li>
		Hospital Civil Madero.
	</li>
	<li>
		Hospital Civil Nuevo Laredo.
	</li>
	<li>
