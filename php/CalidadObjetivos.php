...
<body>
		...
		<h2 class="titulo"><b>CENTRO ESTATAL DE LA TRANSFUSIÓN SANGUÍNEA DE TAMAULIPAS</b></h2>
...
<p>El Centro Estatal de la Transfusión Sanguínea de Tamaulipas brinda un servicio de
calidad y calidez con personal competente, a la población tamaulipeca, cumpliendo con la
normatividad en la disposición de sangre humana y sus componentes con fines
terapéuticos.</p>
<br>
<br>
<div>
...
<ul class="cont-View-Objetivos">
	<li>
		Ofrecer un servicio de calidad y con calidez a la población donante.
	</li>
	<li>
		Contar con capacidad suficiente para atender la demanda hospitalaria con el
		propósito de asegurar el abasto oportuno de sangre y componentes sanguíneos.
	</li>
	<li>
		Asegurar la provisión de sangre segura a los usuarios.
	</li>

	<li>
		Mantener la competencia de la plantilla del personal involucrado en la prestación
		del servicio.
	</li>
	<li>
		Realizar campañas para favorecer la donación altruista de sangre.
	</li>
</ul>
