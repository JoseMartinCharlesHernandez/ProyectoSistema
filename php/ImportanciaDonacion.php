...
<div>
	...
	<h3>LA DONACIÓN ES IMPORTANTE:</h3>	
</div>
<ul class="cont-View-ImportanciaDonacion">
	<li>
		Porque mañana tu o los tuyos pueden necesitar una donación. Nunca se sabe cuándo se necesitará.
	</li>
	<li>
		Porque regenera tu sangre. Cuando tu cuerpo detecta que estás donando,inmediatamente pone en 
		marcha un complejo mecanismo que “fabrica” sangre nueva.
	</li>
		<li>
		Porque donar sangre contribuye a tu salud. Estudios científicos demuestran que las
		personas que donan sangre periódicamente disminuyen el riesgo de enfermedades cardiovasculares.
	</li>
		<li>
		Porque con una sola donación, tú puedes salvar hasta tres vidas, pues de la cantidad de sangre 
		que tú donas, una vez procesada, se extrae una unidad de eritrocitos, otra de plasma y otra de plaquetas.
	</li>
		<li>
		Porque obtienes un buen análisis médico. Para garantizar la seguridad y disminuir
		el riesgo de transmisión de infecciones, todos los productos sanguíneos pasan por
		exámenes rigurosos. Los datos de tu salud que puedes obtener son:
			<ul class="cont-View-ImportanciaDonacion-sublist">
				<li>
	...
	<p>Si encontramos cualquier alteración importante, te sería comunicada de manera inmediata y 100% confidencial.</p>
